//*******************************************************************************************
//  FILE:    XComGameState_HeadquartersProjectPexMTraining.uc
//  AUTHOR:  Mark Nauta  --  11/11/2014 && RustyDios
...
//
//*******************************************************************************************
class XComGameState_HeadquartersProjectPexMTraining extends XComGameState_HeadquartersProject;
...
function SetProjectFocus(StateObjectReference FocusRef, optional XComGameState NewGameState, optional StateObjectReference AuxRef)
{
	...
	if (UnitState.GetSoldierClassTemplateName() == 'PsiOperative') //!='PsiOperative'
	{
...
function int CalculatePointsToTrain(optional bool bClassTraining = false)
{
	...
	//bClassTraining gets set during Project Focus, its TRUE IF they are a PsiOperative
	if (bClassTraining)
	{
	...
	else
	{
		...
		RankDifference = 1; //<>TODO decide is this is 'correct'
...
function OnProjectCompleted()
{
	...
	class'XComHQPresentationLayer_PexM'.static.UIPexMTrainingComplete(ProjectFocus, AbilityTemplate);
